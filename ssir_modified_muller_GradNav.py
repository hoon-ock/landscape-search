...
parent_dir = os.path.join('results/mod_muller/GradNav', argparser.parse_args().dir)
...
valid_init = [] # valid initial points with their numer of sucess identifications
# breakpoint()
for init in tqdm.tqdm(initial_points):
    ...
    if data_count > num_step/10:
        ...
        print(f'failed to identify the cluster: {init_no}')
